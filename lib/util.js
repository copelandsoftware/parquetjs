...
// POC: Assumes s3 output stream.  Could be enhanced to check the T/F response of
...
// POC: Assumes s3 output stream.  Replaces close with end
...
/*
 * POC code: We're hijacking the output stream open here and forcing s3
 * mode.  It would be better to properly separate this, as this feature might
 * be useful for others.
 */
exports.osopen = function(path, opts) {
  return new Promise((resolve, reject) => {
    const s3Connection = new s3fs('scm-parquet-poc', {});
